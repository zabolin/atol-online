...
class Vat
{
     ...
     * - @see VatType::VAT5 – НДС чека по ставке 5%;
     * - @see VatType::VAT7 – НДС чека по ставке 7%;
     * - @see VatType::VAT10 – НДС чека по ставке 10%;
     * - @see VatType::VAT18 – НДС чека по ставке 18%;
     * - @see VatType::VAT20 – НДС чека по ставке 20%;
     * - @see VatType::VAT105 – НДС чека по расчетной ставке 5/105;
     * - @see VatType::VAT107 – НДС чека по расчетной ставке 7/107;
